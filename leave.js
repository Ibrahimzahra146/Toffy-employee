...
function getmessage(formattedFromTime, middayFrom, fromDate, formattedTime, midday, ToDate, email, type, timeOffcase, workingDays, callback) {
    ...
    if (timeOffcase == 1) {
        ...
        messageText = "Okay, you asked for a time off at , " + formattedFromTime + " " + middayFrom + " in  " + fromDate + ", to 5:00:00, and that would be " + workingDays + " working days" + ". Should I go ahead ?"
